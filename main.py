...
Disclaimer:
  ...
  It is NOT a medical device or diagnostic system.
    ...
    parser.add_argument("--dashboard", "--app", action="store_true", dest="dashboard", help="Launch the Streamlit Research Dashboard (port 8501)")
...
def main():
    ...
    if args.dashboard:
        print("\n" + "=" * 60)
        print("  LAUNCHING STREAMLIT RESEARCH DASHBOARD ON http://localhost:8501")
        print("=" * 60 + "\n")
        import subprocess
    ...
    if not any([args.all, args.download, args.preprocess,
        ...
        print("Options:")
        print("  python main.py --dashboard   Launch Streamlit Research Dashboard (http://localhost:8501)")
